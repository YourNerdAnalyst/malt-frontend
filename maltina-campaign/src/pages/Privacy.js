  ...
  return (
    ...
    <div className='terms-inner'>
      <div className='terms-inside'>
        <h1>GENERAL</h1>
          <p>
          Nigerian Breweries Plc located at No 1 Abebe Village Road, Iganmu, Lagos, Nigeria (“NB” or “we” or “us” ) is the controller of the processing of all personal data collected through this website dedicated to NB (the “Website”) and other NB channels (e.g. NB events). NB respects your privacy and is committed to keeping your Personal Data secure and managing it in accordance with our legal responsibilities under applicable data protection laws.
          </p>
          <br></br>
          <p>
          ...
          <br></br>
          <h1>WHAT PERSONAL DATA WE COLLECT AND HOW WE USE YOUR PERSONAL DATA</h1>
          <br></br>
          <p>
          ...
          <br></br>
          <p>
          NB Events, Competitions, Activations, And Other Similar Activities: We may collect videos/images, photographs, social handles, drawings/sketches, and other similar or related personal information in line with the terms and purposes of such events, competitions, activations and similar activities.
          ...
          <br></br>
          <p>
          Heineken group companies if another affiliate is best suited to answer a question you have posted on the Website.
          ...
          In case NB Plc sells all or some of the assets or shares of an NB group company to which Personal Data was transferred to a third party, your Personal Data may be provided to this third party.
          ...
          <br></br>
          <h1>YOUR RIGHTS TO ACCESS, RECTIFICATION, DELETION, RESTRICTION, AND DATA PORTABILITY</h1>
          <br></br>
          <p>
          NB Plc collects Personal Data only for the purposes identified in this Policy and such information cannot be reused for another purpose that is incompatible with the original purpose. This Policy describes your privacy rights regarding our collection, use, storage, sharing and protection of your personal information. You may exercise any of the following rights with respect to your Personal Data with NB Plc: You have the right to:
          Request for and access your personal data collected and stored by NB plc;
          Object to automated decision making.
          Request rectification and modification of personal data kept by NB plc or processed by third parties on NB’s behalf.
          Request for deletion or restriction (as appropriate) of your personal data.
          ...
          Request that NB plc restricts the processing of your personal data; and
          Request for information regarding any specific processing of your personal data.
          You can exercise this right by contacting us with a data privacy request. Please note that requests that do not meet the requirements set out by applicable law or NB’s data protection policy may be requested to be re-issued or 
          ...
          <br></br>
          <h3>Email: privacy.nbplc@heineken.com</h3>
          <br></br>
          <h3>Phone number: 01-271-7400, extension 1362</h3>
          <br></br>
          <h3>Post: Iganmu House, No 1 Abebe Village Road, Iganmu, Lagos</h3>
          <br></br>
      </div>
    </div>
  </div>
